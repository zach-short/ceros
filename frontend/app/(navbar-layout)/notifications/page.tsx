...
import { useNotifications, useNotificationActions } from '@/lib/api/notifications';
...
export default function NotificationsPage() {
  ...
  const { markNotificationRead, dismissNotification, markAllRead } = useNotificationActions();
    ...
    return (
      <div className="container mx-auto px-4 py-8">
        <div className="text-center">
          ...
          <p className="text-gray-600">Failed to load notifications. Please try again later.</p>
        </div>
      </div>
    );
  }
